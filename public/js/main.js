...
function panEnd(event) {
  ...
  var quantizedSoundStartTime = sound.quantizeLength(group.bounds.x / viewWidth * compositionLength); // ms
  var quantizedSoundDuration = sound.quantizeLength(group.bounds.width / viewWidth * compositionLength); // ms
  var compositionObj = {};
