...
},{"./color":4,"./lib/shape-detector":5,"./shape":7,"./sound":8,"./util":9,"hammerjs":2,"howler":3}],7:[function(require,module,exports){
'use strict';
...
function initShapeSounds() {
  ...
  Base.each(config.shapes, function (shape, i) {
    if (shape.sprite) {
      var shapeSoundJSONPath = './audio/shapes/' + shape.name + '/' + shape.name + '.json';
      $.getJSON(shapeSoundJSONPath).then(function (resp) {
        var shapeSoundData = formatShapeSoundData(shape.name, resp);
