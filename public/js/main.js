  ...
  function initCanvasDraw() {
    ...
    function panEnd(event) {
      ...
      if (intersections.length > 0) {
        ...
        var enclosedLoops = util.findInteriorCurves(pathCopy);
